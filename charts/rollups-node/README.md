...
| validator.image | object | `{"digest":null,"registry":null,"repository":"cartesi/rollups-node","tag":null}` | Set the validator docker image |
...
| validator.service.port | int | `10000` |  |
